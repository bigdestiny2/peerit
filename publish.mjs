...
export const SITE_FILES = [
  ...
  'js/app.js', 'js/blob-store.js', 'js/box.js', 'js/bridge-shard-transport.js', 'js/canon.js', 'js/crypto.js', 'js/data.js', 'js/dht-bundle.js', 'js/gossip.js',
  ...
  'js/runtime.js', 'js/seal.js', 'js/sync.js', 'js/util.js', 'js/verify.js'
]
