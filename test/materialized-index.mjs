...
async function main () {
  ...
  index.upsert('report!p2p!target!bob', { _t: 'report', community: 'p2p', targetCid: 'target', author: 'bob', verdict: 'bury', ts: 1 })
  ...
  ok(index.listReportsFor('p2p', 'target').length === 1, 'community report is indexed by exact target')
