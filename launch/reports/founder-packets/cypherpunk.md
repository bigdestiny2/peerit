...
- Title: Cypherpunk
- Audience: Bitcoin, Lightning, privacy engineering, and censorship-resistance builders.
...
- Create one owner/moderator identity for r/cypherpunk.
...
```markdown
# Welcome to r/cypherpunk

This board is for Bitcoin, Lightning, privacy engineering, and censorship-resistance builders.
...
- "What is one Cypherpunk workflow that would benefit from no central account or server?"
- "Show a concrete Cypherpunk build, benchmark, migration, or failure report."
- "What should r/cypherpunk moderate quickly during launch week?"
