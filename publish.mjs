...
export const SITE_FILES = [
  ...
  'js/prefs.js', 'js/pow.js', 'js/legacy-v2-pow-allowlist.js', 'js/ranking.js', 'js/reader-bundle.js', 'js/recovery.js', 'js/relay-pool.js', 'js/relay-roster.js', 'js/release-verify.js',
