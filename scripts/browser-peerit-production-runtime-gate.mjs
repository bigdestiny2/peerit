...
if (mode === 'live-two-relay' && expectedSequence !== 23) fail('live-two-relay is authorized only for sequence 23')
if (mode === 'rollback-preio' && expectedSequence === 23) fail('rollback-preio targets only sequences without the limited Cell-GET authority (!= 23)')
const expectedHeads = {
