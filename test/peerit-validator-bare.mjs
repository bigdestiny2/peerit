...
if (PEERIT_VALIDATOR_PROFILE_BINDING_V1.schemaCount !== 77) throw new Error('Bare validator schema count drift')
...
if (vectorSetHash !== 'cd733144df6984a27411f849099836c889eac3b4b2119bf43f6cb07dbb2be3fb') throw new Error('Bare all-codec vector-set drift')
console.log(JSON.stringify({ schema: 'PeeritValidatorBareRuntimeV1', schemaCount: 77, runtimeVector: actual, vectorSetHash }))
